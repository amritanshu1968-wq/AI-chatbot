  ...
  theme: {
    extend: {
      colors: {
        ...
        // Secondary Colors - Sophisticated depth, premium positioning
        secondary: {
        ...
        // Accent Colors - Instant response energy, success celebration
        accent: {
        ...
        background: "#FAFBFC", // custom light background
